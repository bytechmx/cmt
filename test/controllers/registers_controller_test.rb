...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { colonia: @register.colonia, estado: @register.estado, localidad: @register.localidad, municipio: @register.municipio, nombregrupo: @register.nombregrupo, numero: @register.numero, status: @register.status }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { colonia: @register.colonia, estado: @register.estado, localidad: @register.localidad, municipio: @register.municipio, nombregrupo: @register.nombregrupo, numero: @register.numero, status: @register.status }
    assert_redirected_to register_path(assigns(:register))
  end
