...
class RegistrosControllerTest < ActionController::TestCase
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post :create, registro: { colonia: @registro.colonia, disponible: @registro.disponible, estado: @registro.estado, localidad: @registro.localidad, municipio: @registro.municipio, nombregrupo: @registro.nombregrupo, numero: @registro.numero }
    end
  ...
  test "should update registro" do
    patch :update, id: @registro, registro: { colonia: @registro.colonia, disponible: @registro.disponible, estado: @registro.estado, localidad: @registro.localidad, municipio: @registro.municipio, nombregrupo: @registro.nombregrupo, numero: @registro.numero }
    assert_redirected_to registro_path(assigns(:registro))
  end
